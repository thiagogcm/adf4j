...
/// Reacts to the nodes of an ADF document during one {@link AdfNodeWalker} pass; descent into a
/// node's children is the walker's job, so a collector never re-implements the tree-walk.
